...
## Project Structure
    ...
    ├── testapiautocatalog_111486  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_111486`
...
2. Clone this repo and `cd testapiautocatalog_111486`
